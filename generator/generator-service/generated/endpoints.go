...
func (e Endpoints) Generate(ctx context.Context, in *pb.GenerateRequest) (*pb.GenerateResponse, error) {
	response, err := e.GenerateEndpoint(ctx, in)
	if err != nil {
		return nil, err
	}
	return response.(*pb.GenerateResponse), nil
}

// Make Endpoints

func MakeGenerateEndpoint(s handler.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(*pb.GenerateRequest)
		v, err := s.Generate(ctx, req)
		if err != nil {
			return nil, err
		}
		return v, nil
