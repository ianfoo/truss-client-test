...
func New(instance string) (handler.Service, error) {
	...
	var PrintZeroEndpoint endpoint.Endpoint
	{
		PrintZeroEndpoint = httptransport.NewClient(
			"get",
			copyURL(u, "/print"),
			svc.EncodeHTTPPrintZeroRequest,
			svc.DecodeHTTPPrintResponse,
	...
	return svc.Endpoints{
		...
		PrintEndpoint: PrintZeroEndpoint,
	}, nil
}
